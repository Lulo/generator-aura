...
describe('Aura generator', function() {
  ...
  it ('should generate component', function (done) {
    ...
    componentGenerator.run([], function() {
      ...
      helpers.assertFiles(['app/aura_components/coolComponent/template.html']);
      helpers.assertFiles(['app/aura_components/coolComponent/style.less']);
      helpers.assertFiles(['app/aura_components/coolComponent/spec/main.spec.js']);
      done();
    });
  });
